...
class SpectralSubtraction():
    ...
    def compute(self, signal, noise):
        n_spec = fftw.interfaces.numpy_fft.fft(noise*self._window)
    ...
    def compute_by_noise_pow(self, signal, n_pow):
        ...
        s_spec = fftw.interfaces.numpy_fft.fft(signal*self._window)
        ...
        return sp.real(fftw.interfaces.numpy_fft.ifft(spec))
